...
class Event:
  ...
  def __init__(self, game, period, minute, sec, player, team, start_x, start_y, possession_order, possession_shot, possession_goal, possession_offensive_entry):
    self.game = int(game)
    ...
    self.team = int(team)
    self.possession_order = int(possession_order)
    self.possession_shot = int(possession_shot)
    self.possession_goal = int(possession_goal)
    self.possession_offensive_entry = int(possession_offensive_entry)
    self.comparables = [self.game, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal]

  def toRow(self):
    l = [self.game, self.period, self.min, self.sec, self.player, self.team, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry]
    s = longest - len(l)
...
class Aerial(Event):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.comparables = [self.game, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.outcome]

  def toRow(self):
    l = [self.getType(), self.game, self.period, self.min, self.sec, self.player, self.team, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.outcome]
    s = longest - len(l)
    z = [0 for i in range(s)]
    return l + z
...
class AttackingMove(Event):
  ...
  def toRow(self):
    l = [self.getType(), self.game, self.period, self.min, self.sec, self.player, self.team, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.end_x, self.end_y, self.t]
    s = longest - len(l)
    z = [0 for i in range(s)]
    return l + z
...
class BallRecovery(Event):
  ...
  def toRow(self):
    l = [self.getType(), self.game, self.period, self.min, self.sec, self.player, self.team, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry]
    s = longest - len(l)
    z = [0 for i in range(s)]
    return l + z
...
class Pass(Event):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.possession_pass = int(kwargs.get('possession_pass'))
    ...
    self.comparables = [self.game, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.outcome, self.end_x, self.end_y, self.angle, self.distance, self.crosses, self.header, self.free_kick, self.corner, self.possession_pass]
  ...
  def toRow(self):
    return [self.getType(), self.game, self.period, self.min, self.sec, self.player, self.team, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.outcome, self.end_x, self.end_y, self.angle, self.distance, self.receiver, self.crosses, 
            self.header, self.free_kick, self.corner, self.possession_pass]
...
class Shot(Event):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.comparables = [self.game, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.goal_y, self.goal_z, self.distance, self.free_kick, self.penalty, self.header, self.other_body_part, self.on_target, self.goal]
  ...
  def toRow(self):
    l = [self.getType(), self.game, self.period, self.min, self.sec, self.player, self.team, self.start_x, self.start_y, self.possession_order, self.possession_shot, self.possession_goal, self.possession_offensive_entry, self.on_target, self.goal, self.goal_y, self.goal_z, self.distance, self.free_kick, self.header,
